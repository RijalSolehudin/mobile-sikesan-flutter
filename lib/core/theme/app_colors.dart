...
class AppColors {
  ...
  static const Color primarySurface = Color(0xFFDCFCE7);  // Soft green badge / background
  static const Color primaryEmerald = Color(0xFF10B981);  // Emerald

  // Background & Surface
  static const Color background = Color(0xFFF8FAFC);      // Off-white / Cool Grey scaffold
  static const Color surface = Color(0xFFFFFFFF);         // Pure White Card
  static const Color surfaceMuted = Color(0xFFF1F5F9);    // Input / Search background
  ...
  static const Color incomeSurface = Color(0xFFDCFCE7);   // Light Green background
